	...
	\node {\textbf{Element}\\- Title}
	  child { 
	    ...
	    child {
	      ...
	      node {\textbf{ScientificElement}\\- Authors/Editors}
	    }
	    node {\textbf{DateElement}\\- Year}
	  }
  ...
  \subsection{Book element}
	...
	\node {\textbf{Element}\\- Title}
	  child { 
	    ...
	    node {\textbf{Book}\\- Publisher\\- Year\\- Edition}
	  }
	...
	\node {\textbf{Element}\\- Title}
	  child { 
	    child {
	      ...
	      child { node {\textbf{Leisure Book}\\- NbrPage\\- Genre\\- Authors} }
	      node {\textbf{Book}\\- Year\\- Edition} 
	    }
	    child { node {\textbf{Leisure Periodicals}\\- Price} }
	    node {\textbf{Published}\\- Publisher}
	  }
	  child { node {\textbf{Scientific Journal}\\- Volume\\- Year\\- Number\\- Publisher\\- Impact\\- Authors/Editors\\- Articles} };
      \end{tikzpicture}
    \end{center}
