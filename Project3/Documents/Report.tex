...
For the last program, we were assigned to compute for each pair of authors $x$ and $y$ ($x \neq y$) the distance between $x$ and $y$. As we decided to use functions to simply the request, we will firstly describe those functions before final instructions.
